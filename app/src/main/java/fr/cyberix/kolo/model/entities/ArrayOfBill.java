...
public class ArrayOfBill extends Vector<Bill> implements KvmSerializable
{
    ...
    public ArrayOfBill(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfBill(java.util.Collection< Bill> initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfBill(SoapObject j){
        ...
        __source=inObj;
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (obj!=null && obj instanceof AttributeContainer)
                {
                    ...
                    Bill j1= (Bill)__envelope.get(j,Bill.class,false);
                    add(j1);
