...
public class ArrayOfAdress extends Vector<Adress> implements KvmSerializable
{
    private transient java.lang.Object __source;

    public ArrayOfAdress()
    {
    }

    public ArrayOfAdress(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfAdress(java.util.Collection< Adress> initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfAdress(SoapObject j){
        ...
        __source=inObj;
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (obj!=null && obj instanceof AttributeContainer)
                {
                    ...
                    Adress j1= (Adress)__envelope.get(j,Adress.class,false);
                    add(j1);
