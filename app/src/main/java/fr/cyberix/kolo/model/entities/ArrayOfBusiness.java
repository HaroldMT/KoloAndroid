...
public class ArrayOfBusiness extends Vector<Business> implements KvmSerializable
{
    private transient java.lang.Object __source;

    public ArrayOfBusiness()
    {
    }

    public ArrayOfBusiness(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfBusiness(java.util.Collection< Business> initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfBusiness(SoapObject j){
