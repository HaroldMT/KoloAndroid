...
public class ArrayOfCustomer extends Vector<Customer> implements KvmSerializable
{
    ...
    public ArrayOfCustomer(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfCustomer(java.util.Collection< Customer> initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfCustomer(SoapObject j){
        ...
        __source=inObj;
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (obj!=null && obj instanceof AttributeContainer)
                {
                    ...
                    Customer j1= (Customer)__envelope.get(j,Customer.class,false);
                    add(j1);
