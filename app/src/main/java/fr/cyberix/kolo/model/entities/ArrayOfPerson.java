...
public class ArrayOfPerson extends Vector<Person> implements KvmSerializable
{
    ...
    public ArrayOfPerson(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfPerson(java.util.Collection< Person> initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfPerson(SoapObject j){
        ...
        __source=inObj;
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (obj!=null && obj instanceof AttributeContainer)
                {
                    ...
                    Person j1= (Person)__envelope.get(j,Person.class,false);
                    add(j1);
