...
public class CustomerAddress extends AttributeContainer implements KvmSerializable
{
    ...
    {
        return this.CodeAddresseType;
    }
    
    public void setCodeAddresseType(String value)
    {
        this.CodeAddresseType = value;     
    }
    ...
    public CustomerAddress(SoapObject j){
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("CodeAddresseType"))
        {
            if(obj!=null)
            {
                if (obj instanceof SoapPrimitive)
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.CodeAddresseType = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.CodeAddresseType = (String)obj;
                }
                else{
                    this.CodeAddresseType = "";
                }
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.CodeAddresseType!=null?this.CodeAddresseType:SoapPrimitive.NullSkip;
        }
