...
public class ArrayOfTopUp extends Vector<TopUp> implements KvmSerializable
{
    ...
    public ArrayOfTopUp(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfTopUp(java.util.Collection< TopUp> initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfTopUp(SoapObject j){
        ...
        __source=inObj;
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (obj!=null && obj instanceof AttributeContainer)
                {
                    ...
                    TopUp j1= (TopUp)__envelope.get(j,TopUp.class,false);
                    add(j1);
