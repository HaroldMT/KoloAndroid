...
public class ArrayOfCity extends Vector<City> implements KvmSerializable
{
    ...
    public ArrayOfCity(int initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfCity(java.util.Collection< City> initialCapactiy)
    {
        super(initialCapactiy);
    }

    public ArrayOfCity(SoapObject j){
        ...
        __source=inObj;
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (obj!=null && obj instanceof AttributeContainer)
                {
                    ...
                    City j1= (City)__envelope.get(j,City.class,false);
                    add(j1);
