...
public class Permission extends AbsRuntimePermission {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        requestAppPermissions(new String[]{Manifest.permission.READ_CONTACTS, Manifest.permission.WRITE_CONTACTS, Manifest.permission.SEND_SMS, Manifest.permission.WRITE_CONTACTS,
