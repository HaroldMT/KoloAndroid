...
public class KolOthenticor {
    ...
    public void SignInAsync(final LoginAttempt loginAttempt,final List<HeaderProperty> headers) throws Exception{
    ...
    public void SignUpAsync(final Registration registration,final List<HeaderProperty> headers) throws Exception{
    ...
    public void SignUpVerificationAsync(final Registration registration,final List<HeaderProperty> headers) throws Exception{
