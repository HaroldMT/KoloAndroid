...
public class P2pTransferAdapter extends GenericRecyclerViewAdapter<TransferP2pDetails, OnRecyclerItemClickListener, P2pTransferViewHolder> {
	
	public P2pTransferAdapter(Context context, OnRecyclerItemClickListener listener) {
